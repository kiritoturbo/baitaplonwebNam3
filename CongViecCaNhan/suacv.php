...
<body>
    ...
    if ($conn != true) {
        ...
        $query = "SELECT * FROM  congviec_cn WHERE id = '$_ID'";
        ...
        if ($conn != true) {
            ...
            if ($ngaybd >  $ngaykt) {
                ...
                if ($tinhtrang == "Hoàn Thành") {
                    $query = "UPDATE congviec_cn SET TenCongViec='" . $tencv . "',
                    MucGia='" . $mucgia . "', 
                    SoNguoiLam='" . $songaylam . "',
                    LoaiCongViec='" . $loaicv . "', 
                    NgayBatDau='" . $ngaybd . "', 
                    NgayKetThuc='" . $ngaykt . "',
                    TinhTrang='" . $tinhtrang . "', 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 border-right">
                                            ...
                                            <div class="form-group" style="margin-bottom: 0rem;">
                                                ...
                                                <input type="text" class="form-control form-control-sm" required name="txtsonguoilam" value="<?php echo $songaylam ?>">
                                            </div>
