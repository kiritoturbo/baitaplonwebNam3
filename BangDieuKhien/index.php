            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="">
                                <div class="card card-outline card-success" style="border-left: 3px solid black;
                                 border-radius: 5px; background-color: #4b9261">
                                    <div>
                                        <h2>
                                            <?php
                                            ...
                                            echo "$count";
                                            ?>
                                            <i class="fas fa-calendar-check" style="margin-left: 60px; font-size: 25px;"></i>
                                        </h2>
                                        <p>Số Công Việc Cá Nhân</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="../BangDieuKhien/TimKiemCV/CongViecDTH.php">
                                <div class="card card-outline card-success" style="border-left: 3px solid black;
                                 border-radius: 5px; background-color: #5190d2">
                                    <div>
                                        <h2>
                                            <?php
                                            $conn = mysqli_connect("localhost", "root", "", "bt_qlcv");
                                            ...
                                            if ($conn != true) {
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        // lấy ra dữ liệu của 1 dòng ở dạng mảng
                                    ...
                                    <div>
                                        <h2>
                                            ...
                                            if ($conn != true) {
                                                ...
                                                $sql = "SELECT * FROM `congviec_cn` WHERE TinhTrang= 'Hoàn Thành'";
                                                $result = mysqli_query($conn, $sql);
                                                if ($result) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        $count++;
                        ...
                        <div class="col-md-3">
                            <a href="">
                                <div class="card card-outline card-success" style="border-left: 3px solid black; border-radius: 5px; background-color: red;">
                                    <div>
                                        <h2>
                                            <?php
                                            $conn = mysqli_connect("localhost", "root", "", "bt_qlcv");
