        ...
        <div id="content">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="m-0">Quản Lý Loại Dự Án</h3>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card-tools" style="margin-left:290px">
                                        <a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="them_lda.php"><i class="fa fa-plus"></i> Thêm Loại Dự Án</a>
                                    </div>
                                </div>
                            </div>
                            <table class="table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="text-align: center">Tên Loại Dự Án</th>
                                ...
                                <tbody>
                                    ...
                                    if ($conn != true) {
                                        ...
                                        $sql = mysqli_query($conn, "select * from `loaida`");
                                        ...
                                        $sql = "SELECT * FROM `loaida` LIMIT $start,$limit";

                                        //----------------------------------Tìm Kiếm + Phân Trang -----------------------------
                                        if (isset($_POST['txtSearch']) && $_POST['txtSearch'] != '') {
                                            $KeyWord = $_POST['txtSearch'];
                                            $sql = mysqli_query($conn, "SELECT * FROM  loaida WHERE TenDuAn LIKE N'%" . $KeyWord . "%' ");
                                            //b1:tính tổng các bản ghi
                                            $total = mysqli_num_rows($sql);
                                            $limit = 5;
                                            //tổng số trang
                                            ...
                                            $cr_page = isset($_GET['page']) ? $_GET['page'] : 1;
                                            $start = ($cr_page - 1) * $limit;
                                            $sql = "SELECT * FROM loaida WHERE TenDuAn LIKE N'%" . $KeyWord . "%' LIMIT $start,$limit";
                                        } else {
                                            //----------------------------phân trang khi click--------------------------------
                                            $sql = mysqli_query($conn, "select * from `loaida`");
                                            //b1:tính tổng các bản ghi
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo '<tr>
                                                      ...
                                                      <td style="text-align: center">
                                                            <button class = "btn btn-primary"><a href="sua_lda.php?id=' . $row['id'] . '"><i class="fas fa-pencil-alt"></i></a></button>
                                                            <button class = "btn btn-danger" onclick="return Del();"><a href="xoa_lda.php?id=' . $row['id'] . '" ><i class="fas fa-trash-alt"></i></a></button>
                                                      </td>
                                                </tr>';
                                            }
                                        }
