            ...
            <ul style="padding-left: 0px;">
                <li>
                    <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <i class="fas fa-user-tie"></i> Tài Khoản</a>
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <!-- //ẩn hiện -->
                        <li>
                            <a href="../login/index.php">Đăng xuất</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div id="content">
            <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <button type="button" id="sidebarCollapse" class="btn btn-info" style="background-color: aqua;">
                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card-tools" style="margin-left:300px">
                                        <a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="themcv.php" style="margin-left:60px"><i class="fa fa-plus"></i> Thêm Công Việc Cá Nhân</a>
                                    </div>
                                </div>
                            </div>
                            <table class="table-bordered">
                                ...
                                <tbody>
                                    ...
                                    if ($conn != true) {
                                        ...
                                        //------------------------------phân trang--------------------------------
                                        // $sql = mysqli_query($conn, "select * from `congviec_cn`");
                                        ...
                                        // $sql = "SELECT * FROM `congviec_cn` LIMIT $start,$limit";
                                        // //hạn chế dữ liệu ra màn hình 

                                        //----------------------------------Tìm Kiếm + Phân Trang -----------------------------
                                        if (isset($_POST['txtSearch']) && $_POST['txtSearch'] != '') {
                                            $KeyWord = $_POST['txtSearch'];
                                            $sql = mysqli_query($conn, "SELECT * FROM  congviec_cn WHERE TenCongViec LIKE N'%" . $KeyWord . "%' ");
                                            //b1:tính tổng các bản ghi
                                            $total = mysqli_num_rows($sql);
                                            $limit = 5;
                                            //tổng số trang
                                            ...
                                            $cr_page = isset($_GET['page']) ? $_GET['page'] : 1;
                                            $start = ($cr_page - 1) * $limit;
                                            $sql = "SELECT * FROM `congviec_cn` WHERE TenCongViec LIKE N'%" . $KeyWord . "%' LIMIT $start,$limit";
                                            //var_dump($sql);
                                        } else {
                                            //------------------------------phân trang--------------------------------
                                            $sql = mysqli_query($conn, "select * from `congviec_cn`");
