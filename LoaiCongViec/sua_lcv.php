...
<body>
    ...
    if ($conn != true) {
        ...
        $query = "SELECT * FROM  loaicv WHERE id = '$_ID'";
    ...
    function UpdateData()
    {
        ...
        if ($conn != true) {
            ...
            //step 2 . wrrite query
            $query = "UPDATE loaicv SET TenLoaiCongViec='" . $Name . "' WHERE id='" . $_GET['id'] . "'";
            //step 3. excute
            $result = mysqli_query($conn, $query);
                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" required name="txtName"  value="<?php echo $tenlcv ?>">
