    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3>Quản Lý Công Việc Cá Nhân</h3>
            </div>
        ...
        <div id="content">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="m-0">Quản Lý Dự Án Lớn</h3>
                        </div>
                    </div>
                            ...
                            <table class="table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="text-align: center">Loại Dự Án</th>
                                ...
                                <tbody>
                                    ...
                                    if ($conn != true) {
                                        ...
                                        // $sql = mysqli_query($conn, "select * from `duanlon`");
                                        ...
                                        // $sql = "SELECT * FROM `duanlon` LIMIT $start,$limit";

                                        //----------------------------------Tìm Kiếm + Phân Trang -----------------------------
                                        if (isset($_POST['txtSearch']) && $_POST['txtSearch'] != '') {
                                            $KeyWord = $_POST['txtSearch'];
                                            $sql = mysqli_query($conn, "SELECT * FROM  duanlon WHERE TenDuAn LIKE N'%" . $KeyWord . "%' ");
                                            //b1:tính tổng các bản ghi
                                            $total = mysqli_num_rows($sql);
                                            $limit = 5;
                                            //tổng số trang
                                            ...
                                            $cr_page = isset($_GET['page']) ? $_GET['page'] : 1;
                                            $start = ($cr_page - 1) * $limit;
                                            $sql = "SELECT * FROM duanlon WHERE TenDuAn LIKE N'%" . $KeyWord . "%' LIMIT $start,$limit";
                                        } else {
                                            //------------------------------phân trang--------------------------------
                                            $sql = mysqli_query($conn, "select * from `duanlon`");
                                            //b1:tính tổng các bản ghi
                                        ...
                                        if ($result) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo '<tr>
                                                      ...
                                                      <td style="text-align: center">' . $loaida . '</td>
                                                      ...
                                                      <button class = "btn btn-danger" style="background-color:#61d8d8 "><a href="../DuAnLon/PhanCongCongViec/index.php?id=' . $row['id'] . '" ><i class="fas fa-eye"></i></a></button>
                                                      <button class = "btn btn-primary"><a href="suada.php?id=' . $row['id'] . '"><i class="fas fa-pencil-alt"></i></a></button>
                                                      <button class = "btn btn-danger" onclick="return Del();"><a href="xoada.php?id=' . $row['id'] . '" ><i class="fas fa-trash-alt"></i></a></button>
                                                      </td>
                                                    </tr>';
                                            }
                                        }
