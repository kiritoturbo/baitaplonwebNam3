        ...
        if ($conn != true) {
            ...
            if ($ngaybd >  $ngaykt) {
                ...
                if ($tinhtrang == "Hoàn Thành") {
                    $query = "INSERT INTO `congviec_cn`(`TenCongViec`, `MucGia`, `SoNguoiLam`, `LoaiCongViec`, `NgayBatDau`, `NgayKetThuc`, `TinhTrang`, `MaMau`) 
                    VALUES ('" . $tencv . "','" . $mucgia . "','" . $songaylam . "','" . $loaicv . "','" . $ngaybd . "','" . $ngaykt . "','" . $tinhtrang . "','#999999')";
                } else {
                    $query = "INSERT INTO `congviec_cn`(`TenCongViec`, `MucGia`, `SoNguoiLam`, `LoaiCongViec`, `NgayBatDau`, `NgayKetThuc`, `TinhTrang`, `MaMau`) 
                    VALUES ('" . $tencv . "','" . $mucgia . "','" . $songaylam . "','" . $loaicv . "','" . $ngaybd . "','" . $ngaykt . "','" . $tinhtrang . "','" . $mamau . "')";
                }
                //step 3. excute
        ...
        <div id="content">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h2 class="m-0">Quản Lý Công Việc Cá Nhân</h2>
                        </div>
                    </div>
                                ...
                                <form method="post">
                                    <div class="row">
                                        <div class="col-md-6 border-right">
                                            ...
                                            <div class="form-group" style="margin-bottom: 0rem;">
                                                <label>Số Người Làm :</label>
                                                <input type="text" class="form-control form-control-sm" required name="txtsonguoilam">
                                            </div>
