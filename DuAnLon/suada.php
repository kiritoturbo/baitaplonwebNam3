...
<body>
    ...
    if ($conn != true) {
        ...
        $query = "SELECT * FROM  duanlon WHERE id = '$_ID'";
    ...
    function UpdateData()
    {
        ...
        if ($conn != true) {
            ...
            if ($ngaybd >  $ngaykt) {
                ...
                $query = "UPDATE duanlon SET TenDuAn='" . $tenda . "', LoaiDuAn='" . $loaida . "', TinhTrang='" . $tinhtrang . "', NgayBatDau='" . $ngaybd . "', NgayKetThuc='" . $ngaykt . "' WHERE id='" . $_GET['id'] . "'";
                //step 3. excute
                $result = mysqli_query($conn, $query);
